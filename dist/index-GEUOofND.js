import { E as d, L as y, l as b, a as _, p as g, e as u, s as S, i as T, f as k, g as W, t } from "./main-BnsP6gu5.js";
import { html as j } from "./index-DTvYKKoZ.js";
import { L as X, E as p } from "./index-QZnwWWEP.js";
const Y = 1, U = 2, G = 3, R = 179, z = 4, v = 180, x = 5, Z = 181, V = 6;
function E(O) {
  return O >= 65 && O <= 90 || O >= 97 && O <= 122;
}
const F = /* @__PURE__ */ new p((O) => {
  let a = O.pos;
  for (; ; ) {
    let { next: e } = O;
    if (e < 0)
...
const D = /* @__PURE__ */ h("endcomment", Z, x), C = /* @__PURE__ */ h("endraw", v, z), N = /* @__PURE__ */ new p((O) => {
  if (O.next == 35) {
  ...
  tokenizers: [F, C, D, N, 0, 1, 2, 3],
  topRules: { Template: [0, 7] },
  specialized: [{ term: 186, get: (O) => I[O] || -1 }, { term: 38, get: (O) => L[O] || -1 }],
  tokenPrec: 0
});
function o(O, a) {
  return O.split(" ").map((e) => ({ label: e, type: a }));
}
const m = /* @__PURE__ */ o("abs append at_least at_most capitalize ceil compact concat date default divided_by downcase escape escape_once first floor join last lstrip map minus modulo newline_to_br plus prepend remove remove_first replace replace_first reverse round rstrip size slice sort sort_natural split strip strip_html strip_newlines sum times truncate truncatewords uniq upcase url_decode url_encode where", "function"), q = /* @__PURE__ */ o("cycle comment endcomment raw endraw echo increment decrement liquid if elsif else endif unless endunless case endcase for endfor tablerow endtablerow break continue assign capture endcapture render include", "keyword"), f = /* @__PURE__ */ o("empty forloop tablerowloop in with as", "keyword"), H = /* @__PURE__ */ o("first index index0 last length rindex", "property"), B = /* @__PURE__ */ o("col col0 col_first col_last first index index0 last length rindex rindex0 row", "property");
function M(O) {
  var a;
...
function J(O = {}) {
  let a = O.filters ? O.filters.concat(m) : m, e = O.tags ? O.tags.concat(q) : q, r = O.variables ? O.variables.concat(f) : f, { properties: $ } = O;
  return (i) => {
    var n;
    let Q = M(i);
    if (!Q)
      return null;
    let s = (n = Q.from) !== null && n !== void 0 ? n : Q.node ? Q.node.from : i.pos, l;
    return Q.type == "filter" ? l = a : Q.type == "tag" ? l = e : Q.type == "expression" ? l = r : l = K(i.state, Q.target, i, $), l.length ? { options: l, from: s, validFor: /^[\w\u00c0-\uffff]*$/ } : null;
  };
}
const OO = /* @__PURE__ */ d.inputHandler.of((O, a, e, r) => r != "%" || a != e || O.state.doc.sliceString(a - 1, e + 1) != "{}" ? !1 : (O.dispatch(O.state.changeByRange(($) => ({
...
const aO = /* @__PURE__ */ w(P.language);
function tO(O = {}) {
  let a = O.base || P, e = a.language == P.language ? aO : w(a.language);
  return new y(e, [
    a.support,
