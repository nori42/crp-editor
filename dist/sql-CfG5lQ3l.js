function s(a) {
  var c = a.client || {}, h = a.atoms || { false: !0, true: !0, null: !0 }, p = a.builtin || e(z), C = a.keywords || e(d), _ = a.operatorChars || /^[*+\-%<>!=&|~^\/]/, o = a.support || {}, y = a.hooks || {}, S = a.dateSQL || { date: !0, time: !0, timestamp: !0 }, j = a.backslashStringEscapes !== !1, N = a.brackets || /^[\{}\(\)\[\]]/, v = a.punctuation || /^[;.,:]/;
  function g(t, i) {
    var r = t.next();
    if (y[r]) {
      var n = y[r](t, i);
    ...
    if (r == ".") {
      ...
      return S.hasOwnProperty(l) && (t.match(/^( )+'[^']*'/) || t.match(/^( )+"[^"]*"/)) ? "number" : h.hasOwnProperty(l) ? "atom" : p.hasOwnProperty(l) ? "type" : C.hasOwnProperty(l) ? "keyword" : c.hasOwnProperty(l) ? "builtin" : null;
    }
  }
  function x(t, i) {
    return function(r, n) {
  ...
  return {
    ...
    token: function(t, i) {
      ...
      var n = t.current();
      return n == "(" ? w(t, i, ")") : n == "[" ? w(t, i, "]") : i.context && i.context.type == n && Q(i), r;
    },
